...
($CD $SCRIPT_PATH/../ && $RM -rf $SCRIPT_PATH/../vendor/ && $RM -rf $SCRIPT_PATH/../bootstrap/cache/*.php)
($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.php' -exec sed -i 's/Botble CMS/Laravel CMS/g' {} \;)
($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.json' -exec sed -i 's/Botble CMS/Laravel CMS/g' {} \;)
($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.php' -exec sed -i 's/Botble Technologies/Anonymous/g' {} \;)
($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.php' -exec sed -i 's/Botble BOT/Anonymous/g' {} \;)
($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.php' -exec sed -i 's/Sang Nguyen/Anonymous/g' {} \;)
($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.php' -exec sed -i 's/botble_session/platform_session/g' {} \;)
($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.php' -exec sed -i 's/botble.com/laravel.com/g' {} \;)
($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.php' -exec sed -i 's/Botble Team/Developer Team/g' {} \;)
($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.php' -exec sed -i 's/Ex: botble/Ex: your-key/g' {} \;)
($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.php' -exec sed -i 's/amazonaws.com\/botble/amazonaws.com\/your-key/g' {} \;)
($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.json' -exec sed -i 's/Sang Nguyen/Anonymous/g' {} \;)

($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.php' -exec sed -i 's/Designed by Nghia Minh//g' {} \;)

($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.stub' -exec sed -i 's/Sang Nguyen/Anonymous/g' {} \;)
($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.stub' -exec sed -i 's/sangnguyenplus@gmail.com/anonymous@anonymous.com/g' {} \;)

# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.php' -exec sed -i 's/Botble\\\\/Platform\\\\/g' {} \;)
# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.json' -exec sed -i 's/Botble\\\\/Platform\\\\/g' {} \;)
# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.sql' -exec sed -i 's/Botble\\\\/Platform\\\\/g' {} \;)
# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.stub' -exec sed -i 's/Botble\\\\/Platform\\\\/g' {} \;)
# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.php' -exec sed -i 's/Botble\\/Platform\\/g' {} \;)
# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.json' -exec sed -i 's/Botble\\/Platform\\/g' {} \;)
# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.sql' -exec sed -i 's/Botble\\/Platform\\/g' {} \;)
# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.stub' -exec sed -i 's/Botble\\/Platform\\/g' {} \;)
# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.env' -exec sed -i 's/Botble\\/Platform\\/g' {} \;)
# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.env' -exec sed -i 's/Botble CMS/Laravel CMS/g' {} \;)
...
if [ -f artisan ]
	then
		# Process https://github.com/botble/laravel-assets
		# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.php' -exec sed -i 's/Botble\\/Platform\\/g' {} \;)
		# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.json' -exec sed -i 's/Botble\\/Platform\\/g' {} \;)
		# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.php' -exec sed -i 's/Botble\\\\/Platform\\\\/g' {} \;)
		# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.json' -exec sed -i 's/Botble\\\\/Platform\\\\/g' {} \;)
		# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.php' -exec sed -i 's/Sang Nguyen/Anonymous/g' {} \;)
		# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.php' -exec sed -i 's/sangnguyenplus@gmail.com/anonymous@anonymous.com/g' {} \;)
		# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.json' -exec sed -i 's/Sang Nguyen/Anonymous/g' {} \;)
		# ($CD $SCRIPT_PATH/../ && $FIND $SCRIPT_PATH/../ -type f -name '*.json' -exec sed -i 's/sangnguyenplus@gmail.com/anonymous@anonymous.com/g' {} \;)
